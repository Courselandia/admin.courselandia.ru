...
const props = defineProps({
  value: {
    type: Object as PropType<IProcessForm>,
    required: true,
  },
  alertMessage: {
    type: String,
...
const emit = defineEmits({
  'update:value': (_: IProcessForm) => true,
  submit: (_: IProcessForm, __?: FormInstance) => true,
  reset: (_?: FormInstance) => true,
});

const form = ref<IProcessForm>(value.value);
