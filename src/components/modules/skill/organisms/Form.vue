...
const props = defineProps({
  value: {
    type: Object as PropType<ISkillForm>,
    required: true,
  },
  alertMessage: {
    type: String,
...
const emit = defineEmits({
  'update:value': (_: ISkillForm) => true,
  submit: (_: ISkillForm, __?: FormInstance) => true,
  reset: (_?: FormInstance) => true,
});

const form = ref<ISkillForm>(value.value);
