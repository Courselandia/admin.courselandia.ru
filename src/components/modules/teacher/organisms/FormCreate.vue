...
const form = ref<ITeacherForm>({
  ...
  title_template: 'Преподаватель {teacher} — отзывы, рейтинг[countTeacherCourses:, список из {countTeacherCourses:курс|genitive}][direction:, направление: {direction}] — Courselandia',
  description_template: 'Все курсы преподавателя {teacher} [direction:, направление: {direction}] — полный список [countTeacherCourses:из {countTeacherCourses:курс|genitive}] преподавателя в каталоге Courselandia.',
  keywords: undefined,
  status: true,
  copied: true,
  comment: undefined,
