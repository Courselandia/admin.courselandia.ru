...
export default [
  {
    ...
    name: 'Publications',
    component: () => import('@/pages/dashboard/publications/Index.vue'),
    meta: {
  ...
  },
  {
    ...
    component: () => import('@/pages/dashboard/publications/Create.vue'),
    meta: {
      layout: 'default-layout',
      middleware: [
        tokenRefresh,
  ...
  },
  {
    ...
    component: () => import('@/pages/dashboard/publications/Update.vue'),
    meta: {
      layout: 'default-layout',
      middleware: [
        tokenRefresh,
