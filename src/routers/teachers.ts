...
export default [
  {
    ...
    name: 'Teachers',
    component: () => import('@/pages/dashboard/teachers/Index.vue'),
    meta: {
  ...
  },
  {
    ...
    name: 'TeacherCreate',
    component: () => import('@/pages/dashboard/teachers/Create.vue'),
    meta: {
      layout: 'default-layout',
      middleware: [
        tokenRefresh,
  ...
  },
  {
    ...
    name: 'TeacherUpdate',
    component: () => import('@/pages/dashboard/teachers/Update.vue'),
    meta: {
      layout: 'default-layout',
      middleware: [
        tokenRefresh,
